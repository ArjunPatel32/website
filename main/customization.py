...
def main_content():
    st.markdown(
        """
        <h4>I'm currently a sophmore at UC Berkeley studying Astrophysics and Applied Math, with a concentration in statistics.</h4>
        """,
        unsafe_allow_html=True
    )
    ...
    st.markdown(
        """
        <h4>I'm passionate about astronomy, coding, poker, videogames, and lifting. 
        I'm always looking for more ways to explore my interests, especially poker. 
        If you know of any good resources or want to play a game, feel free to reach out!</h4>
        """,
        unsafe_allow_html=True
    )
    ...
    st.markdown(
        """
        <h4>
        I am an Assistant Telescope Officer at the Undergraduate Astronomy Society at UC Berkeley, operating various telescopes for events.
    ...
    st.markdown(
        """
        <h4>
        I'm currently working as a Data Science Intern at Dotlas.
