...
def display_about_me():
    ...
    with col1:
        ...
        st.markdown(
            ...
            I’m a junior at UC Berkeley, where I study Astrophysics and Applied Math with a concentration in statistics. I’m very interested in solving the mysteries of the universe through my work and studies, and I’m currently engaged in research and projects that bridge astrophysics and data science.
            </p>
            <p style="font-size: 28px;">
            I am a Quantitative Analyst Intern at AIN Ventures, developing Monte Carlo simulations to model venture portfolio outcomes and collaborating on integrating AI-driven probabilistic modeling into internal forecasting systems. With a strong foundation in Python, statistical analysis, and data visualization, I am looking to apply my skills to quantitative trading, leveraging my passion for data-driven decision-making and problem-solving in fast-paced environments.
            </p>
            """, 
